...
public class CacheEngineImpl<K, V> implements CacheEngine<K, V> {
    ...
    CacheEngineImpl(int maxElements, long lifeTimeMs, long idleTimeMs, boolean isEternal) {
        ...
        this.lifeTimeMs = lifeTimeMs > 0 ? lifeTimeMs : 100;
        this.idleTimeMs = idleTimeMs > 0 ? idleTimeMs : 100;
    ...
    public void put(MyElement<K, V> element) {
        ...
        elements.put(key, (MyElement<K, SoftReference<V>>) element);
    ...
    private boolean isT1BeforeT2(long t1, long t2) {return t1 < t2 + TIME_THRESHOLD_MS;}
}
